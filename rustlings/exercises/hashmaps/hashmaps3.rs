...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        let mut team_scores = scores.entry(team_1_name).or_insert(Team { goals_scored: 0, goals_conceded: 0 });
        team_scores.goals_scored += team_1_score;
        team_scores.goals_conceded += team_2_score;

        let mut team_scores = scores.entry(team_2_name).or_insert(Team { goals_scored: 0, goals_conceded: 0 });
